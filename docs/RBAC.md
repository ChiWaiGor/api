...
3. Deploy and run `npm run prisma:seed` to upsert the permission row.
...
- [ ] Run migrations and seed in each environment.
- [ ] Rotate `JWT_*` secrets; set strong `SEED_ADMIN_PASSWORD`.
